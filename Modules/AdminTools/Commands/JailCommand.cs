...
[AutomaticExecution]
[RemoteAdminCommand(CommandName = "Jail", Aliases = [], Description = "Jails a player", Parameters = ["Players"], Permission = "baphomet.remoteadmin.commands", Platforms = [CommandPlatform.RemoteAdmin])]
